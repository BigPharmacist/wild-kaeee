const Icons = {
  ...
  Moped: ({ className = "w-5 h-5" }) => (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M6.5 19a2.5 2.5 0 100-5 2.5 2.5 0 000 5zM17.5 19a2.5 2.5 0 100-5 2.5 2.5 0 000 5z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M4 16.5h-.5a1 1 0 01-1-1v-2a1 1 0 011-1h2l2-3h4l1.5 3H17l2 3h1.5a1 1 0 011 1v2a1 1 0 01-1 1H20" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 16.5h6M11.5 10.5V8a1 1 0 011-1h2" />
    </svg>
  ),
